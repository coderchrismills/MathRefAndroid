...
public class AlgebraLine2SolverActivity extends Activity {
    ...
    public void onCreate(Bundle b) {
    	...
    	setContentView(R.layout.tools_algebra_line2_solver);
	...
	public void compute()
	{
		...
		if(l1x < EPS && l1y < EPS)
		{
			new AlertDialog.Builder(GlobalHelpers.mDialogContext).setTitle("Error").setTitle("A and B cannot be 0").setNeutralButton("OK",
		...
		if(l2x < EPS && l2y < EPS)
		{
			new AlertDialog.Builder(GlobalHelpers.mDialogContext).setTitle("Error").setTitle("C and D cannot be 0").setNeutralButton("OK",
					new DialogInterface.OnClickListener() { 
						public void onClick(DialogInterface dlg, int id) { 
						}
			}).show();
