...
public class UnitConverterDetailView extends RelativeLayout {
	...
	public UnitConverterDetailView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
		
		LayoutInflater inflater = (LayoutInflater)GlobalHelpers.mActivity.getLayoutInflater();
		this.addView(inflater.inflate(R.layout.unit_view, (ViewGroup)this.getParent(), false));

		loadView();
    }
    
    public UnitConverterDetailView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
    
    public UnitConverterDetailView(Context context) {
        this(context, null);
    }
    ...
    public void setupView(int compute)
    {
        ...
        inputAdapter = new ArrayAdapter<String>(GlobalHelpers.mActivity, android.R.layout.simple_spinner_item, spinnerValues);
        inputAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);

        ouputAdapter = new ArrayAdapter<String>(GlobalHelpers.mActivity, android.R.layout.simple_spinner_item, spinnerValues);
