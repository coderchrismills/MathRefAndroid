...
public class AlgebraComplexSolver extends RelativeLayout {

    private final String LOG_TAG="AlgebraComplexSolver";
    ...
    public AlgebraComplexSolver(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        
        LayoutInflater inflater = (LayoutInflater)context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        this.addView(inflater.inflate(R.layout.tools_algebra_complex_solver, null));
    ...
    public AlgebraComplexSolver(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
    
    public AlgebraComplexSolver(Context context) {
        this(context, null);
    }
