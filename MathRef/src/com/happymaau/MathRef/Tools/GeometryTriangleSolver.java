...
public class GeometryTriangleSolver extends RelativeLayout {
	...
	public GeometryTriangleSolver(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        
        LayoutInflater inflater = (LayoutInflater)context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        this.addView(inflater.inflate(R.layout.tools_geometry_triangle_solver, null));
    ...
    public GeometryTriangleSolver(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
    
    public GeometryTriangleSolver(Context context) {
        this(context, null);
    }
