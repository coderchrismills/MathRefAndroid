...
public class TrigRefAngleSolver extends RelativeLayout {
	...
	public TrigRefAngleSolver(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        
        LayoutInflater inflater = (LayoutInflater)context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        this.addView(inflater.inflate(R.layout.tools_trig_refangle_solver, null));
    ...
    public TrigRefAngleSolver(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
    
    public TrigRefAngleSolver(Context context) {
        this(context, null);
    }
