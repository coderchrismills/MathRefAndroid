...
public class TrigInverseAngleSolver extends RelativeLayout {
	...
	public TrigInverseAngleSolver(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        
        LayoutInflater inflater = (LayoutInflater)context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        this.addView(inflater.inflate(R.layout.tools_trig_inverse_angle_solver, null));
    ...
    public TrigInverseAngleSolver(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
    
    public TrigInverseAngleSolver(Context context) {
        this(context, null);
    }
